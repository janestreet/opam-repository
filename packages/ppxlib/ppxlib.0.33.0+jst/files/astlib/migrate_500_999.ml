...
and copy_expression_desc :
  ...
  | Ast_500.Parsetree.Pexp_array x0 ->
      Ast_999.Parsetree.Pexp_array (List.map copy_expression x0)
  ...
  | Ast_500.Parsetree.Pexp_stack e -> Ast_999.Parsetree.Pexp_stack
      (copy_expression e)
...
and copy_pattern_desc :
  ...
  | Ast_500.Parsetree.Ppat_array x0 ->
      Ast_999.Parsetree.Ppat_array (List.map copy_pattern x0)
...
and copy_core_type_desc :
  ...
  function
  | Ast_500.Parsetree.Ptyp_any -> Ast_999.Parsetree.Ptyp_any
  | Ast_500.Parsetree.Ptyp_var x0 -> Ast_999.Parsetree.Ptyp_var x0
  ...
  | Ast_500.Parsetree.Ptyp_alias (x0, x1) ->
      Ast_999.Parsetree.Ptyp_alias (copy_core_type x0, x1)
