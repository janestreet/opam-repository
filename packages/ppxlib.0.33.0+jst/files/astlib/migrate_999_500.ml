...
and copy_expression :
  ...
  fun e ->
    {
      Ast_500.Parsetree.pexp_desc = copy_expression_desc e.pexp_desc;
      Ast_500.Parsetree.pexp_loc = copy_location e.pexp_loc;
      Ast_500.Parsetree.pexp_loc_stack = copy_location_stack e.pexp_loc_stack;
      Ast_500.Parsetree.pexp_attributes = copy_attributes e.pexp_attributes;
    }
...
and copy_expression_desc :
  ...
  | Ast_999.Parsetree.Pexp_array x0 ->
  ...
  | Ast_999.Parsetree.Pexp_newtype (x0, x1) ->
  ...
  | Ast_999.Parsetree.Pexp_stack e -> Ast_500.Parsetree.Pexp_stack
      (copy_expression e)
...
and copy_pattern : Ast_999.Parsetree.pattern -> Ast_500.Parsetree.pattern =
  fun p ->
    { Ast_500.Parsetree.ppat_desc = copy_pattern_desc p.ppat_desc
    ; Ast_500.Parsetree.ppat_loc = copy_location p.ppat_loc
    ; Ast_500.Parsetree.ppat_loc_stack = copy_location_stack p.ppat_loc_stack
    ; Ast_500.Parsetree.ppat_attributes = copy_attributes p.ppat_attributes
    }
  ...
  | Ast_999.Parsetree.Ppat_record (x0, x1) ->
      Ast_500.Parsetree.Ppat_record
        ( List.map
            ...
            x0,
          copy_closed_flag x1 )
  | Ast_999.Parsetree.Ppat_array x0 ->
...
and copy_core_type_desc loc :
  ...
  function
  | Ast_999.Parsetree.Ptyp_any -> Ast_500.Parsetree.Ptyp_any
  | Ast_999.Parsetree.Ptyp_var x0 -> Ast_500.Parsetree.Ptyp_var x0
  ...
  | Ast_999.Parsetree.Ptyp_class (x0, x1) ->
      Ast_500.Parsetree.Ptyp_class
        (copy_loc copy_Longident_t x0, List.map copy_core_type x1)
  | Ast_999.Parsetree.Ptyp_alias (x0, x1) ->
...
and copy_module_expr_desc loc :
  ...
  | Ast_999.Parsetree.Pmod_constraint (x0, x1) ->
...
and copy_module_type_desc :
  ...
  | Ast_999.Parsetree.Pmty_functor (x0, x1) ->
